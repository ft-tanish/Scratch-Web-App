...
const MessageTimer = ({ character, comp_id }) => {
    ...
    return (
        <div className="rounded text-center bg-purple-500 p-2 my-3">
            <div className="grid grid-cols-2 my-2">
                ...
                <input
                    className="mx-2 p-1 py-0 rounded text-center"
                    type="text"
            ...
            <div
                id={comp_id}
                className="flex flex-row flex-wrap rounded text-center bg-purple-700 text-white px-2 py-1 my-2 text-sm cursor-pointer"
